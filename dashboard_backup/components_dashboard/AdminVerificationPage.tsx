...
function DocumentViewer({ userGroup, onClose, onApprove, onReject }: DocumentViewerProps) {
  ...
  const currentImages = [
    ...
    ...(currentDoc.backImageUrl ? [currentDoc.backImageUrl] : [])
  ].filter(Boolean)
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 md:p-4">
      <div className="bg-white rounded-lg w-full max-w-7xl max-h-[95vh] overflow-hidden flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row flex-1 min-h-0">
          ...
          {/* Details Panel */}
          <div className="w-full lg:w-80 border-t lg:border-t-0 lg:border-l border-gray-200 p-4 md:p-6 bg-white overflow-y-auto flex-shrink-0">
            {/* User Info */}
            <div className="mb-6">
