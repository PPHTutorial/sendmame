  ...
  return (
    <>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                <p className="flex items-center">
                  ...
                  <span>{otherParticipant?.user.phone}</span>
                </p>
                <p className="text-xs text-gray-500 mt-1">
                  This is the complete phone number of this user. Copy and dial it on your calling device.
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col h-[calc(100vh-6rem)]">
        ...
        {/* Messages Area */}
        <div ref={messagesContainerRef} className="flex-1 overflow-y-auto py-4 space-y-4 bg-white mx-4 lg:ml-8">
        ...
        {/* Message Input */}
        <div className="py-4 border-t bg-white border-gray-200 mx-4 lg:ml-8">
          {/* Hidden file inputs */}
          <input
            type="file"
            ref={fileInputRef}
