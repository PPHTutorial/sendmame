  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <AuthGuard>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-0 mb-48">
          {/* Back Navigation */}
          <div className="mb-6 mt-4">
            <h1 className="text-4xl font-extrabold">Create Trip</h1>
            <p className="mt-2 text-gray-600">
              Share your travel plans and earn money by delivering packages along with your trip
            </p>
          </div>
            ...
            <div className="flex items-center justify-between">
              {[1, 2, 3, 4].map((stepNumber) => (
                <div key={stepNumber} className="flex items-center w-full">
                  <div
                    className={`w-8 h-8 min-w-8 rounded-full flex items-center justify-center text-sm font-medium ${step >= stepNumber
                  ...
                  {stepNumber < 4 && (
                    <div className={`hidden md:block w-full h-0.5 mx-4 ${step > stepNumber ? 'bg-teal-600' : 'bg-gray-200'
                      }`} />
                  )}
                </div>
              ))}
