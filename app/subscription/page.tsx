...
const features = [
    ...
    { name: 'Total Posts per month', free: 'Five (5)', standard: 'Twenty-Five (25)', premium: 'Hundred (100)', category: 'Limits', isLimit: true },
...
export default function SubscriptionPage() {
    ...
    return (
        <>
            <div className="flex flex-col items-center min-h-screen bg-gradient-to-br from-gray-50 via-white to-teal-50">
